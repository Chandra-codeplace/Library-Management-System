    ...
    <div class="main-content">
        ...
        <div class="form-container">
            <form id="form1" runat="server">
                ...
                <div class="form-group">
                    <label for="pubyr">Publisher Year</label>
                    <input type="date" id="pubyr" name="pubyr" required>
                </div>
                <div class="form-group">
                    <label>Availability</label>
                    <label for="available_yes" class="radio-label" style="display: inline-flex; align-items: baseline; margin-right: 15px;">
                        <input type="radio" id="available_yes" name="availability" value="yes" required style="vertical-align: middle;"> Yes
                    </label>
                    <label for="available_no" class="radio-label" style="display: inline-flex; align-items: baseline;">
                        <input type="radio" id="available_no" name="availability" value="no" style="vertical-align: middle;"> No
                    </label>
                </div>
